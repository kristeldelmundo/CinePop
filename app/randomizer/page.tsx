    ...
    <>
      ...
      <main className="max-w-lg mx-auto px-4 py-10 text-center">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400">{pool.length} titles in the pool</p>
        </div>
            ...
            <div className="animate-[pop_0.3s_cubic-bezier(0.175,0.885,0.32,1.275)]">
              ...
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <span className={clsx(
                  ...
                  pick.added_by === 'K' ? 'bg-rose-100 text-rose-500' : 'bg-purple-100 text-purple-500'
                )}>
                  {pick.added_by}
                </span>
              </div>
              ...
              {pick.plot && (
                <p className="text-sm text-gray-500 leading-relaxed max-w-xs mx-auto">{pick.plot}</p>
              )}
            </div>
          )}
        </div>
        ...
        >
          <Shuffle size={20} />
          {spinning ? 'Picking...' : pick ? 'Pick again!' : 'Pick tonight\'s watch!'}
        </button>
        ...
        {pool.length === 0 && (
          <p className="text-sm text-gray-400 mt-4">
            Your watchlist is empty! <a href="/watchlist" className="text-rose-500 underline">Add some titles first</a>.
          </p>
        )}
      </main>
    </>
